...
// Checking whether the user agrees with the terms of use.
$isAgreeCheckBox.change(function () {
    // Get a submit input element.
    if (this.checked) {
        // Unset 'agree' error.
        errors["agree"] = false;
    } else {
